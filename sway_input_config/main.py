...
class MainWindow(QMainWindow):
    def __init__(self, settings, data_dir, input_backend: InputBackend):
    ...
    def on_clicked_apply(self):
        ...
        self.input_backend.save_keyboard_settings(self.settings)
        self.input_backend.save_pointer_settings(self.settings)
        self.input_backend.save_touchpad_settings(self.settings)
        self.input_backend.save_tablet_settings(self.settings)
        reload_sway_config()
